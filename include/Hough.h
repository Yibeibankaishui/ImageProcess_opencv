...
namespace RMWhough{
    ...
    void HoughCircles(const cv::Mat & bin_img, int radius_l, int radius_u, std::vector<Circle> & circles, int Step = 2, int dtheta = 1, int minCount = 120, double threshold=0.8);
    // 输入二值边缘图像
